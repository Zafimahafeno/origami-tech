        ...
        <div class="container">
            <nav class="navContent">
                ...
                <div class="nav">
                    ...
                    <div class="btnNav btnService">
                             Services
                                    <ul class="serviceList">
                                        <li><a href="#">Creation de Site web</a></li>
                                        <li><a href="#">Conception Logo/Design</a></li>
                                        <li><a href="#">Community Management</a></li>
        <!-- Ajoutez plus d'éléments de liste ici si nécessaire -->
                                    </ul>
                    </div>
...
/* Style pour la liste des services */
.serviceList {
  position: absolute;
  top: 100%;
  left: 0;
...
/* Animation pour afficher la liste lors du survol */
.btnService:hover .serviceList {
  display: block;
}

/* Animation pour masquer la liste lorsque le curseur quitte le bouton */
.btnService:not(:hover) .serviceList {
  display: none;
}
